...
export default function ModeZeroPage() {
  ...
  const getEngagementBadgeColor = (potential: string) => {
    ...
    if (pot.includes('viral')) return 'bg-rose-500/10 text-rose-400 border-rose-500/20';
    if (pot.includes('high')) return 'bg-amber-500/10 text-amber-400 border-amber-500/20';
    if (pot.includes('medium')) return 'bg-blue-500/10 text-blue-400 border-blue-500/20';
        ...
        <div className="md:col-span-5 md:sticky md:top-24 space-y-6">
          {!result && (
            <div className="bg-brand-surface border border-brand-border rounded-2xl p-6 shadow-md">
              {/* Progress indicator */}
              <div className="mb-6">
                <div className="flex items-center justify-between text-[10px] font-bold text-brand-text-secondary mb-2.5 uppercase tracking-wider">
              ...
              <form id="niche-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                {step === 1 && (
                  <div className="space-y-6">
                    {/* Passion / Interests */}
                    <div>
                      <label htmlFor="interests" className="block text-sm font-bold text-brand-text-primary mb-1.5">
                        Your Interests / Passions <span className="text-brand-error">*</span>
                      </label>
                      <input
                        type="text"
                        id="interests"
                    ...
                    <div>
                      <span className="block text-sm font-bold text-brand-text-primary mb-2.5">
                        Your Content Style <span className="text-brand-error">*</span>
                      </span>
                    ...
                    <div>
                      <span className="block text-sm font-bold text-brand-text-primary mb-2.5">
                        Target Platform <span className="text-brand-error">*</span>
                      </span>
                      <div className="flex flex-wrap gap-2">
                        {platformsList.map((p) => (
                          <button
                    ...
                    <div className="pt-4 border-t border-brand-border hidden md:flex justify-end">
                      <button
                        ...
                        className="py-2.5 px-5 rounded-xl bg-brand-accent text-brand-bg font-bold text-sm hover:bg-brand-accent/90 transition-all flex items-center gap-1 shadow-sm"
                      >
                        Next Step
                ...
                {step === 2 && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <span className="block text-sm font-bold text-brand-text-primary mb-2.5">
                        Target Audience Age <span className="text-xs text-brand-text-secondary font-normal ml-1">(Optional)</span>
                      </span>
                      <div className="flex flex-wrap gap-2">
                    ...
                    {/* Location */}
                    <div>
                      <label htmlFor="location" className="block text-sm font-bold text-brand-text-primary mb-1.5">
                        Target Location <span className="text-xs text-brand-text-secondary font-normal ml-1">(Optional)</span>
                      </label>
                      <input
                        type="text"
                        id="location"
                    ...
                    <div>
                      <span className="block text-sm font-bold text-brand-text-primary mb-2.5">
                        Audience Language <span className="text-xs text-brand-text-secondary font-normal ml-1">(Optional)</span>
                      </span>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="pt-4 border-t border-brand-border hidden md:flex items-center justify-between">
                      <button
                        ...
                        className="py-2 px-4 rounded-xl border border-brand-border text-brand-text-secondary font-bold text-xs hover:text-brand-text-primary transition-all flex items-center gap-1"
                      >
                        Back
                      </button>
                      <div className="flex gap-2.5">
                        <button
                          ...
                          className="py-2 px-4 rounded-xl text-brand-text-secondary hover:text-brand-accent text-xs font-bold transition-all"
                        >
                          Skip
                        </button>
                        <button
                          ...
                          className="py-2.5 px-5 rounded-xl bg-brand-accent text-brand-bg font-bold text-xs hover:bg-brand-accent/90 transition-all flex items-center gap-1 shadow-sm"
                        >
                          Next
                        </button>
                      </div>
                ...
                {step === 3 && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <span className="block text-sm font-bold text-brand-text-primary mb-2.5">
                        Time Available Per Week <span className="text-xs text-brand-text-secondary font-normal ml-1">(Optional)</span>
                      </span>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div>
                      <span className="block text-sm font-bold text-brand-text-primary mb-2.5">
                        Posts Per Week Goal <span className="text-xs text-brand-text-secondary font-normal ml-1">(Optional)</span>
                      </span>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="pt-4 border-t border-brand-border hidden md:flex items-center justify-between">
                      ...
                      <button
                        type="submit"
                        className="py-3 px-6 rounded-xl bg-brand-accent text-brand-bg font-bold text-xs hover:bg-brand-accent/90 transition-all shadow-md flex items-center gap-1"
                      >
                        Find My Niche →
                      </button>
                    </div>
          ...
          {!result && (
            <div className="md:hidden fixed bottom-16 left-0 right-0 bg-brand-bg/95 backdrop-blur-md p-4 border-t border-brand-border z-40 flex gap-3 shadow-lg">
              {step > 1 && (
                <button
                  type="button"
                  onClick={handlePrevStep}
                  className="px-4 rounded-xl border border-brand-border bg-brand-surface text-brand-text-primary text-xs font-bold active:scale-[0.99]"
                >
                  Back
                </button>
              )}
              {step === 1 && (
                <button
                  type="button"
                  onClick={handleNextStep1}
                  className="flex-1 py-3 px-6 rounded-xl bg-brand-accent text-brand-bg font-bold text-sm hover:bg-brand-accent/90 transition-all active:scale-[0.99] shadow-sm"
                >
                  Next Step
                </button>
              )}
              {step === 2 && (
                <>
                  <button
                    type="button"
                    onClick={handleSkipStep2}
                    className="px-4 rounded-xl border border-brand-border text-brand-text-secondary text-xs font-bold active:scale-[0.99]"
                  >
                    Skip
                  </button>
                  <button
              ...
              {step === 3 && (
                <button
                  ...
                  form="niche-form"
                  disabled={loading}
                  className="flex-1 py-3.5 rounded-xl bg-brand-accent text-brand-bg font-bold text-sm hover:bg-brand-accent/90 transition-all active:scale-[0.99] flex items-center justify-center gap-2 shadow-sm"
                >
                  {loading ? (
                    <span>Analyzing...</span>
                  ) : (
          ...
          {loading && (
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="bg-brand-surface border border-brand-border rounded-2xl p-6 md:p-8 space-y-3">
                ...
                <div className="h-6 w-1/2 rounded bg-brand-surface-elevated animate-shimmer" />
                <div className="h-4 w-full rounded bg-brand-surface-elevated animate-shimmer" />
                <div className="h-4 w-5/6 rounded bg-brand-surface-elevated animate-shimmer" />
              </div>

              {/* Pillars shimmers */}
              <div className="space-y-4">
                <div className="h-6 w-28 rounded bg-brand-surface animate-shimmer" />
                  ...
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-brand-surface border border-brand-border rounded-2xl p-6 h-48 flex flex-col justify-between">
                      <div className="space-y-2">
                        <div className="h-4 w-12 rounded bg-brand-surface-elevated animate-shimmer" />
          ...
          {!loading && !result && (
            <div className="bg-brand-surface border border-brand-border border-dashed rounded-2xl p-8 text-center flex flex-col items-center justify-center min-h-[400px] group hover:border-brand-accent/30 transition-colors">
              ...
              <h3 className="font-heading text-lg font-bold text-brand-text-primary mb-2">
                Your content identity will appear here
              </h3>
          ...
          {result && !loading && (
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-brand-accent bg-brand-accent/10 px-3 py-1 rounded-full border border-brand-accent/20 uppercase tracking-wider">
                  {platform} Identity
                </span>
              </div>
              ...
              <div className="bg-brand-surface border border-brand-border rounded-2xl p-6 md:p-8 shadow-sm space-y-4">
                <span className="text-[10px] font-extrabold uppercase tracking-widest text-brand-accent bg-brand-accent/10 px-2.5 py-0.5 rounded border border-brand-accent/15">
              ...
              <div className="space-y-4">
                ...
                <div className="flex overflow-x-auto scroll-snap-x no-scrollbar md:grid md:grid-cols-1 gap-4 pb-4 md:pb-0 -mx-4 px-4 md:mx-0 md:px-0">
                  {result.firstSevenPosts.map((post, index) => (
                    <div 
                      key={index} 
                      className="scroll-snap-align-start w-[85vw] shrink-0 md:w-full bg-brand-surface border border-brand-border rounded-xl p-5 shadow-xs flex flex-col justify-between gap-3"
                    >
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="inline-block px-2 py-0.5 rounded-full text-[9px] font-extrabold uppercase tracking-wider border bg-brand-surface-elevated text-brand-text-primary border-brand-border">
                            {post.format}
                          </span>
                          <span className={`inline-block px-2.5 py-0.5 rounded-full text-[9px] font-extrabold uppercase tracking-wider border ${getEngagementBadgeColor(post.engagementPotential)}`}>
              ...
              {/* 4. First Hook Card */}
              <div className="bg-brand-surface border border-brand-border rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                <div className="space-y-1">
                  <h3 className="font-heading text-md font-bold text-brand-text-primary flex items-center gap-2">
                    🪝 First Post Hook Concept (Tanglish Mix)
                  </h3>
                  <p className="text-sm text-brand-text-primary font-semibold italic">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-brand-surface border border-brand-border rounded-2xl p-6 shadow-sm border-l-4 border-l-brand-accent">
